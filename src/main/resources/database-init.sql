...
--         '农家小炒肉Stir Fried Pork with Pepper', 13.99, 3),
--        ('',
...
--         '三味茄子Eggplant with Minced Pork, Garlic, Cilantro', 14.99, 3),
--        ('Mild spicy.',
...
--         '大盆花菜Stir Fried Cauliflower with Pork', 14.99, 3),
--        ('Mild spicy.',
...
--         '酸汤鱼片Poached Fish Fillets in Sour Soup', 17.99, 3),
--        ('Very spicy.',
...
--         '小炒黄牛肉Stir Fried Beef with Pepper', 16.99, 3),
--        ('Medium spicy.',
...
--         '水煮牛肉Poached Sliced Beef in Hot Chili Oil', 17.99, 3),
...
--         '擂辣椒茄子皮蛋Smashed Green Pepper, Chinese Eggplant & Preserved Egg', 11.99, 3),
--        ('',
