...
//
//
//import com.networking.demo.entity.*;
//import com.networking.demo.repository.*;
...
//
//    public DevRunner(
//            com.networking.demo.repository.CourseRepository courseRepository,
...
//        this.cartRepository = courseRepository;
...
//        );
//        platformRepository.saveAll(newRestaurants);
...
//
//
//        learnerRepository.deleteById(2L);
//        platformRepository.deleteById(4L);
//        learnerRepository.updateNameById(1L, "first", "last");
//
//
